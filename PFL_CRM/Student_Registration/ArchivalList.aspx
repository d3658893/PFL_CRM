<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"  CodeBehind="ArchivalList.aspx.cs" Inherits="PFL_CRM.Student_Registration.ArchivalList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-white fw-bolder fs-3 my-1">Archival List
                    </h1>
                    <!--end::Title-->
                </div>
            </div>
    ...
    <script>
        ...
        function GetLiveStudents() {
            ...
            $.ajax({
                type: "post",
                url: "/Student_Registration/ArchivalList.aspx/GET_ARCHIVAL_STUDENTS",
                contentType: "application/json; charset=utf-8",
                //data: param,
                datatype: "json",
        ...
        function DeleteComplaint(id) {
            Swal.fire({
                ...
                text: "Do you really want to Revive this Student?",
                icon: "success",
                buttons: true,
                dangerMode: true,
            }).then((willDelete) => {
                if (willDelete.isConfirmed) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "/Student_Registration/ArchivalList.aspx/Revive_STUDENT",
                        contentType: "application/json; charset=utf-8",
                        data: param,
                        datatype: "json",
                    ...
                    function delete_Student(response) {
                        if (response.d[0]['Column1'] == '1') {
                            Swal.fire({
                                icon: 'success',
                                title: 'Student Revived successfully',
                                showConfirmButton: false,
                                timer: 5000
                            })
                            GetLiveStudents();
            ...
            Swal.fire({
                ...
                if (response.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        showConfirmButton: false,
                        timer: 500,
                        title: 'Approval Rejected By Sales Manager!'
                    })
                }
            })
        }
