<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"  CodeBehind="SalesM_Approval.aspx.cs" Inherits="PFL_CRM.Student_Registration.SalesM_Approval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-white fw-bolder fs-3 my-1">SALES APPROVAL
                    </h1>
                    <!--end::Title-->
                </div>
            </div>
    ...
    <script>
                                ...
                                },
                                {
                                    ...
                                    render: function (data, type, full, meta) {
                                        if (full[21]=='5') {
                                            ...
                                            var delete_data = '<a onclick="DeleteComplaint(' + full[1] + ')" href="javascript:void(0)"  class="btn btn-icon btn-success h-30px w-30px mx-1"><i  class="fa fa-check fs-base"></i></a>';
                                            ...
                                            return delete_data + reject_data;
                                        }
                                    }
                                }
                            ]
        ...
        function GetLiveStudents() {
            ...
            $.ajax({
                type: "post",
                url: "/Student_Registration/SalesM_Approval.aspx/SalesManager_PendingApproval",
                contentType: "application/json; charset=utf-8",
                //data: param,
                datatype: "json",
        ...
        function DeleteComplaint(id) {
            Swal.fire({
                ...
                text: "Do you really want to Approve this Student as SalesManager ?",
                icon: "success",
                buttons: true,
                dangerMode: true,
            }).then((willDelete) => {
                if (willDelete.isConfirmed) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "/Student_Registration/SalesM_Approval.aspx/ApproveBySales_STUDENT",
                        contentType: "application/json; charset=utf-8",
                        data: param,
                        datatype: "json",
                    ...
                    function delete_Student(response) {
                        if (response.d[0]['Column1'] == '1') {
                            Swal.fire({
                                icon: 'success',
                                title: 'Sales Manager Approved successfully',
                                showConfirmButton: false,
                                timer: 5000
                            })
                            GetLiveStudents();
        ...
        function RejectApproval(id) {
            Swal.fire({
                ...
                preConfirm: (login) => {
                    ...
                    return $.ajax({
                        type: "post",
                        url: "/Student_Registration/SalesM_Approval.aspx/RejectBySales_STUDENT",
                        contentType: "application/json; charset=utf-8",
                        data: param,
                        datatype: "json"
                    })
                ...
                if (response.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        showConfirmButton: false,
                        timer: 500,
                        title: 'Student Dropped By Sales Manager!'
                    })
                        GetLiveStudents();
