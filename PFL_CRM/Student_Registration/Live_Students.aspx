<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Live_Students.aspx.cs" Inherits="PFL_CRM.Student_Registration.Live_Students" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-white fw-bolder fs-3 my-1">REGISTERED STUDENTS 
                    </h1>
                    <!--end::Title-->
                </div>
            </div>
    ...
    <script>
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    render: function (data, type, full, meta) {
                                        ...
                                        var delete_data = '<a onclick="DeleteComplaint(' + full[1] + ')" href="javascript:void(0)"  class="btn btn-icon btn-danger h-30px w-30px mx-1"><i  class="fa fa-trash fs-base"></i></a>';
                                        ...
                                        return view_data + delete_data + document_data + documentview_data;
                                    }
                                }
                            ]
                        })
        ...
        function GetLiveStudents() {
            ...
            $.ajax({
                type: "post",
                url: "/Student_Registration/Live_Students.aspx/GET_LIVE_STUDENTS",
                contentType: "application/json; charset=utf-8",
                //data: param,
                datatype: "json",
        ...
        function DeleteComplaint(id) {
            Swal.fire({
                ...
                if (willDelete.isConfirmed) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "/Student_Registration/Live_Students.aspx/DELETE_LIVE_STUDENT",
                        contentType: "application/json; charset=utf-8",
                        data: param,
                        datatype: "json",
                    ...
                    function delete_Student(response) {
                        if (response.d[0]['Column1'] == '1') {
                            Swal.fire({
                                icon: 'success',
                                title: 'Live Student deleted successfully',
                                showConfirmButton: false,
                                timer: 5000
                            })
                            GetLiveStudents();
